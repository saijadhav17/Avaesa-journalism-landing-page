      ...
      <div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            />
            <div className="text-xl text-Blue uppercase tracking-wide font-bold">
              Insightful
            </div>
          </div>
          ...
          {toggle && (
            <motion.div
              ...
              className="fixed h-full w-96 top-0 left-0 z-20 bg-Blue text-white flex flex-col justify-center items-center shadow-lg gap-8 py-8"
            >
              {navLinks.map((navLink) => {
                return (
                  <MobileNavLinks
